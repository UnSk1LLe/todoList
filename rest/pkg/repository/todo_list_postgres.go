...
func (r *TodoListPostgres) GetById(userId int, listId int) (rest.TodoList, error) {
...
func (r *TodoListPostgres) Update(userId, listId int, input rest.UpdateListInput) error {
